...
# BluePilot: BP settings panel + BP button styling
...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    # BluePilot: insert BP settings panel button
    if is_bluepilot():
      bp_panel = BluePilotLayoutMici(back_callback=gui_app.pop_widget)
      bluepilot_btn = SettingsBigButton(tr("bluepilot"), "", gui_app.texture("icons_mici/settings/car_icon.png", ICON_SIZE, ICON_SIZE))
