...
if gui_app.sunnypilot_ui():
  ...
  # BluePilot: upstream added HomeLayoutSP here, which would clobber the HomeLayoutBP
  # override above (is_bluepilot() and sunnypilot_ui() are both true on a BP device).
  if not is_bluepilot():
...
class MainLayout(Widget):
  def __init__(self):
    ...
    # Initialize layouts
    # BluePilot: comma body is not a BluePilot target; body layout/dispatch deliberately omitted.
